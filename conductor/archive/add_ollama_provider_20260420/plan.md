...
- [x] Task: Verify Full Workflow with Ollama (2511360)
    - [x] `tests/test_full_workflow.py`를 실행하여 Ollama 기반으로 전체 인쿼리 엔진이 작동하는지 확인
    - [x] Ollama 미실행 시 "Friendly Notification" 에러 처리가 의도대로 작동하는지 검증
